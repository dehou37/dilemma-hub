...
export default function EditDilemmaPage() {
    ...
    fetch(`http://localhost:5000/api/dilemmas/${id}`)
      ...
      .then((data) => {
        ...
        if (data.authorId !== currentUser.id) {
          setError("You are not authorized to edit this dilemma");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to the dilemma page
      router.push(`/dilemma/${id}`);
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-zinc-50 py-8">
      <div className="max-w-3xl mx-auto px-4">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-zinc-900">Edit Dilemma</h1>
          <p className="text-zinc-600 mt-2">Update your dilemma details</p>
        </div>
